...
defined('MAX_ROW_LIMIT_LOAD')      OR define('MAX_ROW_LIMIT_LOAD', 100001); // Spread sheet row limit preview
defined('MAX_ROW_LIMIT_TO_PROCESS')      OR define('MAX_ROW_LIMIT_TO_PROCESS', 1000); // Spread sheet row limit preview
